...
public enum Type {
	...
	LESS, GREATER_THAN, LESS_THAN, EQUAL, COMPARE, SEMICOLON, COMMA, COLON, EXPRESSION, CONTENT_BLOCK, EOL,
	SINGLE_QUOTE, DOUBLE_QUOTE, PROPERTY, IDENTIFIER, TEXT, BLANK, AT, UNDERSCORE, NAME, CONTENT
}
