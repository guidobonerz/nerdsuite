...
public class LexicalRule {
	...
	public final static LexicalRule INT_VALUE_BYTE = new LexicalRule("#[0-9]{1,5}");
	...
	public final static LexicalRule SLASH = new LexicalRule("/");
	public final static LexicalRule BACKSLASH = new LexicalRule("\\");
	public final static LexicalRule STAR = new LexicalRule("*");
	public final static LexicalRule PERCENT = new LexicalRule("%");
	public final static LexicalRule XOR = new LexicalRule("^");
	public final static LexicalRule AMPERSAND = new LexicalRule("&");
	public final static LexicalRule PIPE = new LexicalRule("|");
	public final static LexicalRule HASH = new LexicalRule("#");
