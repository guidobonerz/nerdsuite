...
public class NewSourceFileWizardPage extends AbstractBoundWizardPage {
	...
	protected void initDataBindings() {
		 ...
		 * widgetDataBinder.bind(sourceFileNameText, getModel(), Constants.NAME, new
		 * LengthValidator("Filename", 1, CheckType.Min));
		 * widgetDataBinder.bind(sourceFileNameText, getModel(), Constants.NAME, new
		 * DuplicateNameValidator("Filename", null)); IObservableCollection oc =
