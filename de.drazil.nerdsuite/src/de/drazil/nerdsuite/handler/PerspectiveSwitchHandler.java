...
public class PerspectiveSwitchHandler {
    ...
    public void execute(IEventBroker broker, EPartService partService, MApplication app, EModelService modelService,
        ...
        if ("u64life".equals(perspectiveId)) {
            E4Utils.switchPerspective("de.drazil.nerdsuite.perspective.U64AppStreamer", app, modelService, partService);
        } else if ("u64debug".equals(perspectiveId)) {
            E4Utils.switchPerspective("de.drazil.nerdsuite.perspective.ultimate64debug", app, modelService,
                    partService);
            ...
            E4Utils.switchPerspective("de.drazil.nerdsuite.perspective.DisassemblerPerspective",
                    app, modelService, partService);
        } else {
