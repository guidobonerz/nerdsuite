...
public class NumericConverter
{
	...
	{
		return getWordAsInt(byteArray, offset, false);
	}

	public static int getWordAsInt(byte byteArray[], int offset, boolean swapLowAndHighByte)
	{
		int value = 0;
		byte[] bytes = getWord(byteArray, offset, swapLowAndHighByte);
		value |= ((int) bytes[0] << 8);
	...
	{
		return getWord(byteArray, offset, true);
	}

	public static byte[] getWord(byte byteArray[], int offset, boolean swap)
	{
