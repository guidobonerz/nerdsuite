...
{
	public final static RGB toRGB(String hexValue)
	{
		return new RGB(Integer.valueOf(hexValue.substring(1, 3), 16), Integer.valueOf(hexValue.substring(3, 5), 16), Integer.valueOf(hexValue.substring(5, 7), 16));
	}
