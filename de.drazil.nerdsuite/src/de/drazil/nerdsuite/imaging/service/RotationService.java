...
public class RotationService extends AbstractImagingService {
	...
	public void each(int action, int tileIndex, Tile tile, TileRepositoryService repositoryService,
		...
		rotate(action, content, sourceContentSelection, targetContentSelection, tileWidth, selection, multicolor,
				width);
	...
	private void rotate(int action, int[] data, int[] source, int[] target, int tileWidth, Rectangle selection,
			boolean multicolor, int width) {
